...
// 팔로잉 목록 조회
$following = $followModel->getFollowing($targetUserId, 100);

// 각 사용자에 대한 팔로우 여부 확인 (현재 사용자가)
...
<head>
    ...
    <title><?= e($targetUser['name']) ?>님의 팔로잉 - 신년계획 관리</title>
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="page-header">
                <h2>👥 <?= e($targetUser['name']) ?>님의 팔로잉</h2>
                ...
                <?php else: ?>
                    <div class="users-grid">
                        <?php foreach ($following as $user): ?>
                            <?php if ($user['id'] === $userId) continue; // 자기 자신 제외 ?>
